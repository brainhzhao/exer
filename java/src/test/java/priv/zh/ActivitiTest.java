...
public class ActivitiTest {
    ...
    public void createTable(){
        ...
        processEngineConfiguration.setJdbcUrl("jdbc:mysql://localhost:3306/activitidemo?useUnicode=true&characterEncoding=utf8");
    ...
    public void createGroup(){
        ...
        System.out.println("group:"+searchGroup.getId()+",name:"+searchGroup.getName()+",type:"+searchGroup.getType());
    }
